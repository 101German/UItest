...
namespace BookingTests
{
    public static class WaitUntil
    {
        public static void ShouldLocate(IWebDriver webDriver, string location)
        {
            ...
            {
                throw new NotFoundException($"Can't find iut that app in specific location: {location}", ex);
            }
        }
        ...
        public static void WaitElement(IWebDriver webDriver,By locator,int seconds = 15)
        {
